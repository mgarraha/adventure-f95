...
1004  READ(1,'(A80)')TXT
      ...
      READ(TXT(TAB+1:),1005)(LINES(J),J=LINUSE+1,LINUSE+9),KK
1005  FORMAT(10A8)
      IF(KK.NE.Z"2020202020202020")CALL BUG(0)
      DO 1006 K=1,9
      KK=LINUSE+10-K
      IF(LINES(KK).NE.Z"2020202020202020")GOTO 1007
1006  CONTINUE
...
1042  ATAB(TABNDX)=IEOR(ATAB(TABNDX),IA5('PHROG'))
      CALL BUG(4)
...
19999 K=43
     ...
     1        .OR.WD2.EQ.IA5('WATER')))GOTO 2010
      ...
      IF((WD1.NE.IA5('WATER').AND.WD1.NE.IA5('OIL'))
     1        .OR.(WD2.NE.IA5('PLANT').AND.WD2.NE.IA5('DOOR')))GOTO 2610
      IF(AT(VOCAB(WD2,1)))WD2=IA5('POUR')
2610  IF(WD1.NE.IA5('WEST'))GOTO 2630
      IWEST=IWEST+1
