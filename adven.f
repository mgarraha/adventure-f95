...
C     100 OBJECTS
      ...
      CHARACTER*80 TXT
      CHARACTER*5 WORD
      INTEGER IA5,VOCAB,PUT,RANI
      EXTERNAL IA5,VOCAB,PUT,RANI
     ...
     1        VRBSIZ/35/,RTXSIZ/205/,CLSMAX/12/,HNTSIZ/20/,MAGSIZ/35/
      ...
      INTEGER BOTTLE,PBOTL,WATER,OIL
...
1004  READ(1,'(A80)')TXT
      ...
      END DO
      KK=LINES(LINUSE+15)
C      READ(TXT(TAB+1:),1005)(LINES(J),J=LINUSE+1,LINUSE+14),KK
C1005  FORMAT(15A5)
...
6010  DTOTAL=0
     ...
     4            .OR.IABS(TRAVEL(KK))/1000000.EQ.100)) THEN
               TK(J)=NEWLOC
               J=J+1
            END IF
            KK=KK+1
...
2000  IF(LOC.EQ.0)GOTO 99
      ...
      IF (.NOT.FORCED(LOC) .AND. DARK(0)) THEN
